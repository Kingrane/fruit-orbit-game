(() => {
    ...
    const FRUITS = [
        { name: 'cherry', radius: 12, color: '#e53935', points: 1 },
        { name: 'strawberry', radius: 18, color: '#e91e63', points: 2 },
        { name: 'grape', radius: 24, color: '#7b1fa2', points: 4 },
        { name: 'mandarin', radius: 28, color: '#f57c00', points: 8 },
        { name: 'persimmon', radius: 34, color: '#e64a19', points: 16 },
        { name: 'apple', radius: 38, color: '#c62828', points: 32 },
        { name: 'pear', radius: 42, color: '#9e9d24', points: 64 },
        { name: 'peach', radius: 46, color: '#ff8a65', points: 128 },
        { name: 'pineapple', radius: 52, color: '#f9a825', points: 256 },
        { name: 'melon', radius: 56, color: '#388e3c', points: 512 },
        { name: 'watermelon', radius: 64, color: '#2e7d32', points: 1024 }
    ];
